...
<div class="file-box">
<form name="loginForm" id="loginForm" action="${pageContext.request.contextPath}/BusinessServlet/img_upload2.do" method="post" enctype="multipart/form-data" style="width:600px;margin-left:65%;" target="hiddenFrame">
...
<button style="margin-left:60px" type="button" class='btn btn-info' id="cancle">cancle</button><!-- class="btn btn-default" -->
</div>
