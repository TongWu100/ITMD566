...
<span>用户名称：</span>
<input style="width:200px" type="text" class="form-control" id="username" name="username" maxlength="10" value="<%=request.getAttribute("username").toString()%>"  disabled="true"/>
</div> 

<div class="form-group">
<span>邮箱：</span>
<input style="width:200px" type="text" class="form-control" id="email" name="email" maxlength="16" value="<%=request.getAttribute("email").toString()%>"  disabled="true"/>
</div> 

<div class="form-group">
<span>密码：</span>
<input style="width:200px" type="password" class="form-control" id="password" name="password" maxlength="6" 
 onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" value="<%=request.getAttribute("password").toString()%>"  disabled="true"/>
</div> 
...
value="<%=request.getAttribute("account").toString()%>"/>
</div> 
 
<div class="form-group">
<span>权限等级：</span>
<input style="width:200px" type="text" class="form-control" id="rights_id"  maxlength="3" 
value="<%=request.getAttribute("role").toString()%>"/>
</div>  

<div class="form-group">
<span>城市：</span>
<input style="width:200px" type="text" class="form-control" id="city"  maxlength="3" 
value="<%=request.getAttribute("city").toString()%>"/>
</div> 

<div class="form-group">
<span>地区：</span>
<input style="width:200px" type="text" class="form-control" id="streetAddress"  maxlength="3" 
value="<%=request.getAttribute("streetaddress").toString()%>"/>
</div>
