...
public class FileUtil {
	...
	/**
	 * 复制文件 从源路径到目标文件夹路径，文件名保持一致 如果目标文件夹不存在则自动创建 如果文件已经存在则自动编号-copy n
	 *
	 * @param srcFile
	 *            源文件绝对路径
	 * @param dstDir
	...
	/**
	 * 复制文件或文件夹 如果目标文件夹不存在则自动创建 如果文件或文件夹已经存在则自动编号-copy n
	 *
	 * @param src
	 *            源文件或文件夹绝对路径
	 * @param dstDir
	...
	/**
	 * 移动文件或文件夹 如果目标文件夹不存在则自动创建 如果文件或文件夹已经存在则自动编号-copy n
	 *
	 * @param src
	 *            源文件或文件夹绝对路径
	 * @param dstDir
	...
	public static void main(String[] args) {
		...
		File srcFile2 = new File("F:\\WPACS\\recv_images\\");
